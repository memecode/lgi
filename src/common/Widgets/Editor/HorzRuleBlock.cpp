...
bool LRichTextPriv::HorzRuleBlock::ToHtml(LStream &s, LArray<LDocView::ContentMedia> *Media, LRange *Rng)
{
	s.Print("<hr>\n");
	return true;
}
...
bool LRichTextPriv::HorzRuleBlock::HitTest(int offset, HitTestResult &htr)
{
